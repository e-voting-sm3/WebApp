    ...
    <div class="topbar d-flex align-items-center">
      <nav class="navbar navbar-expand">
        ...
        <div class="top-menu-left d-none d-lg-block">
          <ul class="nav">
            <li class="nav-item">
              <a class="nav-link" href="http://127.0.0.1:8000/app-emailbox"
                ><i class="bx bx-envelope"></i
              ></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://127.0.0.1:8000/app-chat-box"
                ><i class="bx bx-message"></i
              ></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://127.0.0.1:8000/app-fullcalender"
                ><i class="bx bx-calendar"></i
              ></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://127.0.0.1:8000/app-to-do"
